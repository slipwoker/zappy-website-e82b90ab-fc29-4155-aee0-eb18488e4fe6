    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ניגע בעומק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e82b90ab-fc29-4155-aee0-eb18488e4fe6',
                    name: data.name || '',
                    email: data.email || '',
